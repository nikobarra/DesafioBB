...
for pelicula in link_movie_array: #recorro cada link obteniendo toda la info necesaria
    ...
    meta_movie = driver.find_elements_by_xpath('//*[@id="subview-container"]/starz-movie-details/div/div/section/div[1]/div[2]/section/ul/li')
...
df.to_csv('./Desafio/MetaDataMovies.csv', index=False)    
